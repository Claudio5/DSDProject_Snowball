...
begin
  ...
  BUZZER : entity buzzer_sound_v1_00_a.buzzer_ctrl(RTL)
  port map(
		ClockxCI => Bus2IP_Clk,
		ResetxRB => Bus2IP_Reset,
		BuzzerEnxDI => slv_reg0(C_SLV_DWIDTH-1),
		BuzzerCounterxDI => slv_reg1(C_SLV_DWIDTH-32 to C_SLV_DWIDTH-1),
