...
ARCHITECTURE behavior OF ps2_keyboard_to_ascii IS
  ...
  SIGNAL check					: std_logic:='0';										-- boolean that permits to not count two times or more

  --declare PS2 keyboard interface component
  COMPONENT ps2_keyboard_logic IS
    GENERIC(
...
BEGIN
  ...
  ps2_keyboard_0:  ps2_keyboard_logic
  ...
  IF(clk'EVENT AND clk = '1') THEN
	counter <= counter+1;
	IF(counter = 3500000 or check = '1') then
