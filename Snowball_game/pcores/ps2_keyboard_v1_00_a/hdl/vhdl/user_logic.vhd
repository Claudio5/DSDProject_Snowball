...
-- Date:              Mon May 22 15:08:05 2017 (by Create and Import Peripheral Wizard)
...
architecture IMP of user_logic is
  ...
  signal PS2_CodexDO : std_logic_vector(6 downto 0);
  signal PS2_NewxDO : std_logic;
...
begin
  ...
  ps2_keyboard : entity ps2_keyboard_v1_00_a.ps2_keyboard_to_ascii(behavior)
    port map(
		ps2_clk  => PS2_ClockxDI,
		ps2_data => PS2_DataxDI,
		clk 			=> Bus2IP_Clk,
		--ascii_new 	=> slv_reg0(C_SLV_DWIDTH-1),
		--ascii_code	=> slv_reg1(C_SLV_DWIDTH-7 to C_SLV_DWIDTH-1)
		ascii_code => PS2_codexDO,
		ascii_new => PS2_NewxDO
  ...
  begin
    ...
    case slv_reg_read_sel is
      when "10000000" => slv_ip2bus_data <= (0 to 30 => '0') & PS2_NewxDO;--slv_reg0;
      when "01000000" => slv_ip2bus_data <= (0 to 24 => '0') & PS2_CodexDO; --slv_reg1;
